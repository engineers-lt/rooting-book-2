...
我が組織のウォーターフォールのすごさ（？）に感銘を受けたのでしょう、当日の会場からは、生唾を飲む音が何度も聞こえました。
DevOpsを手本に改善してゆくことを宣言し、私はLTを締めくくりました。

あとになって自覚したことですが、このとき私はまだDevOpsが含む概念を捉えきれておらず、
この言葉を「とてもスマートなやり方」程度の意味で軽々しく口にしてしまっていました。
しかしエンジニアの方々に共感や励ましのお言葉をいただき、初めて自身の活動を、あながち無意味ではないと肯定的に捉えることができました。
...
三人という数字は、集団の最小単位です。
DevOpsという得体の知れない概念を説く時、一人で活動したのでは、周囲には持論を振りかざすただの奇人に映るでしょう。
...
私達DevOps部――まだ三人しかいませんが――は、組織を輝かせるための草の根活動を計画中です。
...
開発者とは、プログラムを書く人達のことではありません。成果物の質、そしてそれを生み出す過程を常に改善していく集団のことです。
あるいは、継続的に考え、学び続ける生き方のことかもしれません。
...
私は、余白を保つべきと考えます。
テクノロジーの進化とともに情報が流れる速度は増しましたが、この効率化によって、私達の仕事は楽になったでしょうか？
よい仕事には、余白が必要なのです――思考の熟成、あるいはさらなる学びのために。
手を抜くという言葉は、特に官公庁組織にとっては、受け入れがたい響きをもっていますす。
...
私は、ビジョンは直接関係なくとも、なにかに向かって奮闘する人はみな、大切な仲間だと思っています。
