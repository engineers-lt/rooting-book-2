...
長崎生活が3年目に入っていた秋、毎週土曜は、市内のカフェで読書するのが妻との習慣になっていました。
それぞれが思い思いに、ノンフィクションや小説など、その時読みたいものをゆったりと読むだけ時間だったのですが、
ある週から私は、積ん読になっていたHadley Wickhamの『Rパッケージ開発』を読み始めました。
業務で必要になったわけではなく、ただなんとなく。
このとき、私のR歴は既に6年目に入っていましたが、文中に出てくる用語はどれも出会ったことがないものでした。
手を動かしながら学ぶ必要性を感じ、次週からはラップトップを持ち込み、手を動かしながら読むことにしました。

自分と開発者たちとの違いを知ったのは、テストという概念に出会ったときでした。
とくに、回帰テストが失敗するのを初めて見たとき
――「自分史上、最高に賢い」今の自分による自信たっぷりのコミットが、「愚かだった」過去の自分が書いたプログラムを壊す瞬間を目の当たりにしたとき――
私は心の底から謙虚になることができました。
また同時に、テストという概念は私たちの働き方を根本から変えるものだと確信しました。
...
プログラミングには、ユーザー的なものと開発者的なものがあることを知った冬だった。
「テスト」「ビルド」の概念に触れて以来、スクリプトとコードを明確に意識するようになった
いくつかパッケージを書くうちに、研究業務、いや全ての知識活動はソフトウェアそのものだと気づいた
同時にパッケージのスコープに悩むようになり、「製品」「顧客」という考え方の重要性に気づいた
うまくコンピュータに仕事をまかせて、本当に集中すべきことに集中する働き方だと知った。
また個人の能力差を小さくし、プロジェクトの成功確率を高めてくれるとも思った。

処理を一般化し、テストを書いてパッケージの形へと整えていった。
